...
public class RefextRefExtractTrainer extends RefExtractTrainer {
    ...
    public static void main(String[] args)
        ...
        RefextRefExtractTrainer refextRefExtractTrainer = new RefextRefExtractTrainer(trainingTargetDirectory);
        refextRefExtractTrainer.train(trainingSourceDirectory, featureNames);
    }
     ...
     */
    public RefextRefExtractTrainer(File trainingTargetDirectory) {
     ...
     */
    public RefextRefExtractTrainer(File trainingTargetDirectory, List<String> featureNames) {
        this.trainingTargetDirectory = trainingTargetDirectory;
    }

    public void train(File trainingSourceDirectory, List<String> featureNames)
            throws IOException, InterruptedException, ParseException, AnalysisException, LangDetectException {
        ...
        File modelOutputFile = new File(this.trainingTargetDirectory + File.separator + "model.ser");
